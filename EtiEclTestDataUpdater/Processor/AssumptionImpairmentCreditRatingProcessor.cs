...
{
    public class AssumptionImpairmentCreditRatingProcessor
    {
        private readonly DataAccess _dataAccess;

        public AssumptionImpairmentCreditRatingProcessor(DataAccess dataAccess)
        {
        ...
        public void Execute()
        {
            ...
            if (dataList.Count > 0)
            {
                ...
                {
                    var qry = Queries.UpdateImpairmentCreditRatingAssumption(item) + "\n";
        ...
        public List<ImpairmentCreditRating> ReadFromExcel()
        {
            ...
            {
                ExcelWorksheet worksheet = package.Workbook.Worksheets[15]; //Impairment_CreditRating Sheet
                ...
                for (int i = 2; i <= rows; i++)
                {
                    ...
                    else
                    {
                        ...
                        try { data.Value = value.ToString(); } catch { data.Value = ""; }
